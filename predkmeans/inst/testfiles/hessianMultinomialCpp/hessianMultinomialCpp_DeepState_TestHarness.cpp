...
TEST(,){
  ...
  qs::c_qsave(p,"/home/akhila/fuzzer_packages/fuzzedpackages/predkmeans/inst/testfiles/hessianMultinomialCpp/inputs/p.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "p values: "<< p << std::endl;
  IntegerVector k(1);
  k[0]  = RcppDeepState_int();
  qs::c_qsave(k,"/home/akhila/fuzzer_packages/fuzzedpackages/predkmeans/inst/testfiles/hessianMultinomialCpp/inputs/k.qs",
		"high", "zstd", 1, 15, true, 1);
