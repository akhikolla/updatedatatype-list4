...
TEST(,){
  ...
  std::string d_t = "/home/akhila/fuzzer_packages/fuzzedpackages/ppgmmga/inst/testfiles/EntropyGauss/libFuzzer_EntropyGauss/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_d.qs";
  qs::c_qsave(d,d_t,
