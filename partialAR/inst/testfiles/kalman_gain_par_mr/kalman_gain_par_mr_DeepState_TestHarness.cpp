...
TEST(,){
  ...
  qs::c_qsave(rho,"/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/inputs/rho.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rho values: "<< rho << std::endl;
  NumericVector sigma_M(1);
  sigma_M[0]  = RcppDeepState_double();
  qs::c_qsave(sigma_M,"/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/inputs/sigma_M.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "sigma_M values: "<< sigma_M << std::endl;
  NumericVector sigma_R(1);
  sigma_R[0]  = RcppDeepState_double();
  qs::c_qsave(sigma_R,"/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/inputs/sigma_R.qs",
		"high", "zstd", 1, 15, true, 1);
