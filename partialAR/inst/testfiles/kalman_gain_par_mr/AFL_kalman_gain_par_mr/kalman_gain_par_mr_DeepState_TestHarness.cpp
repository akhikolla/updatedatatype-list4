...
TEST(,){
  ...
  std::string rho_t = "/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/AFL_kalman_gain_par_mr/afl_inputs/" + std::to_string(t) + "_rho.qs";
  qs::c_qsave(rho,rho_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rho values: "<< rho << std::endl;
  NumericVector sigma_M(1);
  sigma_M[0]  = RcppDeepState_double();
  std::string sigma_M_t = "/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/AFL_kalman_gain_par_mr/afl_inputs/" + std::to_string(t) + "_sigma_M.qs";
  ...
  std::string sigma_R_t = "/home/akhila/fuzzer_packages/fuzzedpackages/partialAR/inst/testfiles/kalman_gain_par_mr/AFL_kalman_gain_par_mr/afl_inputs/" + std::to_string(t) + "_sigma_R.qs";
