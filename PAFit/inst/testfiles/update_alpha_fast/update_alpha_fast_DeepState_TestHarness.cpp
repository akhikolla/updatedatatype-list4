...
TEST(,){
  ...
  qs::c_qsave(non_zero_theta,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/non_zero_theta.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "non_zero_theta values: "<< non_zero_theta << std::endl;
  NumericVector norm  = RcppDeepState_NumericVector();
  qs::c_qsave(norm,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/norm.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "norm values: "<< norm << std::endl;
  NumericVector f  = RcppDeepState_NumericVector();
  qs::c_qsave(f,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/f.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "f values: "<< f << std::endl;
  NumericVector PA_offset(1);
  PA_offset[0]  = RcppDeepState_double();
  qs::c_qsave(PA_offset,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/PA_offset.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "PA_offset values: "<< PA_offset << std::endl;
  NumericVector theta  = RcppDeepState_NumericVector();
  qs::c_qsave(theta,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/theta.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "theta values: "<< theta << std::endl;
  NumericMatrix degree  = RcppDeepState_NumericMatrix();
  qs::c_qsave(degree,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/degree.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "degree values: "<< degree << std::endl;
  NumericVector m_t  = RcppDeepState_NumericVector();
  qs::c_qsave(m_t,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/m_t.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "m_t values: "<< m_t << std::endl;
  NumericVector Sum_m_k  = RcppDeepState_NumericVector();
  qs::c_qsave(Sum_m_k,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/Sum_m_k.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Sum_m_k values: "<< Sum_m_k << std::endl;
  NumericMatrix offset_tk  = RcppDeepState_NumericMatrix();
  qs::c_qsave(offset_tk,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/offset_tk.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "offset_tk values: "<< offset_tk << std::endl;
  NumericVector offset(1);
  offset[0]  = RcppDeepState_double();
  qs::c_qsave(offset,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/offset.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "offset values: "<< offset << std::endl;
  NumericVector alpha_old(1);
  alpha_old[0]  = RcppDeepState_double();
  qs::c_qsave(alpha_old,"/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_alpha_fast/inputs/alpha_old.qs",
		"high", "zstd", 1, 15, true, 1);
