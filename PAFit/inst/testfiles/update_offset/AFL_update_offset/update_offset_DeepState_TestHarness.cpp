...
TEST(,){
  ...
  std::string offset_n_tk_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_offset_n_tk.qs";
  ...
  std::string offset_m_tk_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_offset_m_tk.qs";
  ...
  std::string theta_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_theta.qs";
  qs::c_qsave(theta,theta_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "theta values: "<< theta << std::endl;
  NumericVector normalized_  = RcppDeepState_NumericVector();
  std::string normalized_const_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_normalized_const.qs";
  ...
  std::string m_t_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_m_t.qs";
  qs::c_qsave(m_t,m_t_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "m_t values: "<< m_t << std::endl;
  NumericVector shape(1);
  shape[0]  = RcppDeepState_double();
  std::string shape_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_shape.qs";
  qs::c_qsave(shape,shape_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "shape values: "<< shape << std::endl;
  NumericVector rate(1);
  rate[0]  = RcppDeepState_double();
  std::string rate_t = "/home/akhila/fuzzer_packages/fuzzedpackages/PAFit/inst/testfiles/update_offset/AFL_update_offset/afl_inputs/" + std::to_string(t) + "_rate.qs";
