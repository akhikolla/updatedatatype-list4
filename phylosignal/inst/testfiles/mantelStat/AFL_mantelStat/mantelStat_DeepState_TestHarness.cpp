...
TEST(,){
  ...
  std::string xr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/phylosignal/inst/testfiles/mantelStat/AFL_mantelStat/afl_inputs/" + std::to_string(t) + "_xr.qs";
  qs::c_qsave(xr,xr_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "xr values: "<< xr << std::endl;
  NumericMatrix Wr  = RcppDeepState_NumericMatrix();
  std::string Wr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/phylosignal/inst/testfiles/mantelStat/AFL_mantelStat/afl_inputs/" + std::to_string(t) + "_Wr.qs";
  qs::c_qsave(Wr,Wr_t,
		"high", "zstd", 1, 15, true, 1);
