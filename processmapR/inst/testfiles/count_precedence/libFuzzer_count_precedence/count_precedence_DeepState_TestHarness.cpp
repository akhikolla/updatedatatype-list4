...
TEST(,){
  ...
  std::string cases_t = "/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/libFuzzer_count_precedence/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_cases.qs";
  qs::c_qsave(cases,cases_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cases values: "<< cases << std::endl;
  IntegerVector activities  = RcppDeepState_IntegerVector();
  std::string activities_t = "/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/libFuzzer_count_precedence/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_activities.qs";
  ...
  std::string lead_t = "/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/libFuzzer_count_precedence/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_lead.qs";
