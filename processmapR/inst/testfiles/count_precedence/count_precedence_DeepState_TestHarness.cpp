...
TEST(,){
  ...
  qs::c_qsave(cases,"/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/inputs/cases.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "cases values: "<< cases << std::endl;
  IntegerVector activities  = RcppDeepState_IntegerVector();
  qs::c_qsave(activities,"/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/inputs/activities.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "activities values: "<< activities << std::endl;
  IntegerVector lead(1);
  lead[0]  = RcppDeepState_int();
  qs::c_qsave(lead,"/home/akhila/fuzzer_packages/fuzzedpackages/processmapR/inst/testfiles/count_precedence/inputs/lead.qs",
		"high", "zstd", 1, 15, true, 1);
