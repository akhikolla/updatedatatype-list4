...
TEST(,){
  ...
  std::string X_t = "/home/akhila/fuzzer_packages/fuzzedpackages/partialCI/inst/testfiles/estimate_rho_par_c/AFL_estimate_rho_par_c/afl_inputs/" + std::to_string(t) + "_X.qs";
  qs::c_qsave(X,X_t,
