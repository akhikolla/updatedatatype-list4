...
TEST(,){
  ...
  qs::c_qsave(X,"/home/akhila/fuzzer_packages/fuzzedpackages/partialCI/inst/testfiles/estimate_par_c/inputs/X.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X values: "<< X << std::endl;
  NumericVector rho_max(1);
  rho_max[0]  = RcppDeepState_double();
  qs::c_qsave(rho_max,"/home/akhila/fuzzer_packages/fuzzedpackages/partialCI/inst/testfiles/estimate_par_c/inputs/rho_max.qs",
		"high", "zstd", 1, 15, true, 1);
