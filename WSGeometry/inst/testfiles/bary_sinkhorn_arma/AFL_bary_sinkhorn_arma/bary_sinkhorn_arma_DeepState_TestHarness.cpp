...
TEST(,){
  ...
  std::string maxIter_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WSGeometry/inst/testfiles/bary_sinkhorn_arma/AFL_bary_sinkhorn_arma/afl_inputs/" + std::to_string(t) + "_maxIter.qs";
  ...
  std::string lambda_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WSGeometry/inst/testfiles/bary_sinkhorn_arma/AFL_bary_sinkhorn_arma/afl_inputs/" + std::to_string(t) + "_lambda.qs";
  ...
  std::string thresh_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WSGeometry/inst/testfiles/bary_sinkhorn_arma/AFL_bary_sinkhorn_arma/afl_inputs/" + std::to_string(t) + "_thresh.qs";
  qs::c_qsave(thresh,thresh_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "thresh values: "<< thresh << std::endl;
  IntegerVector threads(1);
  threads[0]  = RcppDeepState_int();
  std::string threads_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WSGeometry/inst/testfiles/bary_sinkhorn_arma/AFL_bary_sinkhorn_arma/afl_inputs/" + std::to_string(t) + "_threads.qs";
