...
TEST(,){
  ...
  std::string r_t = "/home/akhila/fuzzer_packages/fuzzedpackages/WRI/inst/testfiles/kernel_partialF/libFuzzer_kernel_partialF/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_r.qs";
  qs::c_qsave(r,r_t,
