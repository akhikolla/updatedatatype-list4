...
TEST(,){
  ...
  std::string word_t = "/home/akhila/fuzzer_packages/fuzzedpackages/phonics/inst/testfiles/soundex_internal/AFL_soundex_internal/afl_inputs/" + std::to_string(t) + "_word.qs";
  qs::c_qsave(word,word_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "word values: "<< word << std::endl;
  IntegerVector maxCodeLen(1);
  maxCodeLen[0]  = RcppDeepState_int();
  std::string maxCodeLen_t = "/home/akhila/fuzzer_packages/fuzzedpackages/phonics/inst/testfiles/soundex_internal/AFL_soundex_internal/afl_inputs/" + std::to_string(t) + "_maxCodeLen.qs";
