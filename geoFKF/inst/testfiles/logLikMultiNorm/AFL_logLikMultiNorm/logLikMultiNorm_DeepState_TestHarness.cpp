...
TEST(,){
  ...
  std::string s2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/geoFKF/inst/testfiles/logLikMultiNorm/AFL_logLikMultiNorm/afl_inputs/" + std::to_string(t) + "_s2.qs";
  qs::c_qsave(s2,s2_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "s2 values: "<< s2 << std::endl;
  NumericVector phi(1);
  phi[0]  = RcppDeepState_double();
  std::string phi_t = "/home/akhila/fuzzer_packages/fuzzedpackages/geoFKF/inst/testfiles/logLikMultiNorm/AFL_logLikMultiNorm/afl_inputs/" + std::to_string(t) + "_phi.qs";
  std::string p_t = "/home/akhila/fuzzer_packages/fuzzedpackages/geoFKF/inst/testfiles/logLikMultiNorm/AFL_logLikMultiNorm/afl_inputs/" + std::to_string(t) + "_p.qs";
