...
TEST(,){
  ...
  std::string nInit_t = "/home/akhila/fuzzer_packages/fuzzedpackages/porridge/inst/testfiles/ridgePgen/AFL_ridgePgen/afl_inputs/" + std::to_string(t) + "_nInit.qs";
  ...
  std::string minSuccDiff_t = "/home/akhila/fuzzer_packages/fuzzedpackages/porridge/inst/testfiles/ridgePgen/AFL_ridgePgen/afl_inputs/" + std::to_string(t) + "_minSuccDiff.qs";
