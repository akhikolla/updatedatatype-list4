...
TEST(,){
  ...
  std::string NumbBoot_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pacotest/inst/testfiles/EC/libFuzzer_EC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_NumbBoot.qs";
  ...
  std::string Grouping_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pacotest/inst/testfiles/EC/libFuzzer_EC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_Grouping.qs";
  ...
  std::string finalComparison_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pacotest/inst/testfiles/EC/libFuzzer_EC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_finalComparison.qs";
  ...
  std::string ExpMinSampleSize_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pacotest/inst/testfiles/EC/libFuzzer_EC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_ExpMinSampleSize.qs";
  ...
  std::string TrainingDataFraction_t = "/home/akhila/fuzzer_packages/fuzzedpackages/pacotest/inst/testfiles/EC/libFuzzer_EC/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_TrainingDataFraction.qs";
